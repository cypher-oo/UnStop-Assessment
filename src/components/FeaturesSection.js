...
const FeaturesSection = () => {
  ...
  return (
    <div className='feature-container'>
     ...
     <div className="card card-with-bg text-center" style={{width: "21.5rem", marginLeft:'20px', marginTop:'20px'}}>
  <div className="card-body">
    <button className='button-add'>
  <img src={vector} alt='vector'style={imageStyle} />
  </button>
    <h4 className="card-title">New Assessment</h4>
    <p className="card-text" style={{fontSize:'19px'}}>From here you can add questions of multiple types like MCQs, subjective (text or paragraph)!</p>
   
  </div>
</div>
    
<div className="card" style={{width: "21rem", marginLeft:'20px', marginTop:'20px'}}>
  <div className="card-body">
...
<div className='footer'>
    <h6 className='duration'> 00 <br/><p style={{fontSize:'17px'}}>Duration</p> </h6>
     <h6 className='questions'> 00 <br/><p style={{fontSize:'17px'}}>Questions</p> </h6>
